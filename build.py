...
def compile_js(manifest,config):
	js_file = os.path.join(cwd,'assets','com.elijahwindsor.parsemodule.js')
	...
	f = os.path.join(cwd,'Classes','ComElijahwindsorParsemoduleModuleAssets.m')
	c = open(f).read()
...
ignoreFiles = ['.DS_Store','.gitignore','libTitanium.a','titanium.jar','README','com.elijahwindsor.parsemodule.js']
